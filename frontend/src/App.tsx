                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-500">
                                Autonomous CI/CD Healing Core <span className="text-[10px] opacity-70 font-mono ml-2 border border-blue-500/30 px-1.5 py-0.5 rounded text-blue-400">PRO LIVE (v1.13)</span>
